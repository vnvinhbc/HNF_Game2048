...
/* Definitions for joyQueue */
osMessageQueueId_t joyQueueHandle;
const osMessageQueueAttr_t joyQueue_attributes = {
  .name = "joyQueue"
};
/* USER CODE BEGIN PV */
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the queue(s) */
  /* creation of joyQueue */
  joyQueueHandle = osMessageQueueNew (4, sizeof(uint8_t), &joyQueue_attributes);
